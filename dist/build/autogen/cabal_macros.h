...
/* package haskerdo-0.1.0.0 */
#define VERSION_haskerdo "0.1.0.0"
#define MIN_VERSION_haskerdo(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package network-3.1.0.0 */
#define VERSION_network "3.1.0.0"
...
#define CURRENT_COMPONENT_ID "haskerdo-0.1.0.0"

#define CURRENT_PACKAGE_KEY "haskerdo-0.1.0.0"
